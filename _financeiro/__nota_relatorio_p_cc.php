...
if (pode("i", $_SESSION["permissao"])) {
	...
	*/
	...
	$result= mysql_query("select * from fi_notas, pessoas, pessoas_tipos, fi_pessoas_cc_tipos
							where fi_notas.id_empresa = '". $_SESSION["id_empresa"] ."' 
							and   fi_pessoas_cc_tipos.id_pessoa = fi_notas.id_cedente
							and   fi_pessoas_cc_tipos.id_centro_custo_tipo = '". $_POST["id_centro_custo_tipo"] ."'
							and   fi_notas.tipo_nota = '$tipo_nota'
							and   fi_notas.id_cedente = pessoas.id_pessoa
							and   pessoas.id_pessoa = pessoas_tipos.id_pessoa 
							and   pessoas_tipos.tipo_pessoa = '$tipo_cedente'
