...
<div id="conteudo_interno">
    <fieldset>
        <legend>Formulário de busca do período</legend>
            ...
            <div class="parte50">
                <form action="index2.php?pagina=rh/atestado_relatorio" target="_blank" method="post" name="formAtestadoBuscar" id="formAtestadoBuscar">
