...
<div id="conteudo_interno">
    <fieldset>
        <legend>Formulário de busca do período</legend>
            ...
            <div class="parte50">
                <form action="index2.php?pagina=rh/escala_relatorio" method="post" target="_blank" name="formEscalaBuscar" id="formEscalaBuscar" onsubmit="return validaFormNormal('validacoes');">
