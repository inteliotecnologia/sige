...
if (pode_algum("ap", $_SESSION["permissao"])) {
	...
	if ( (pode("p", $_SESSION["permissao"])) && ($_GET["tipo_empresa"]=="c") ) $tipo_empresa= "c";
	elseif (pode("a", $_SESSION["permissao"])) $tipo_empresa= "a";
...
<form action="<?= AJAX_FORM; ?>formEmpresa&amp;acao=<?= $acao; ?>" method="post" name="formEmpresa" id="formEmpresa" onsubmit="return ajaxForm('conteudo', 'formEmpresa', 'validacoes', true);">
    ...
    <fieldset>
        ...
        <div class="parte50">
            ...
            <input name="cei" type="checkbox" class="tamanho20" <? if($rs->cei==1) echo "checked=\"checked\""; ?> value="1" /> 
            <br />
            <? } ?>
        </div>
    </fieldset>
