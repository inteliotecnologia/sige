...
<div class="parte50">
    <fieldset>
        ...
        <form action="index2.php?pagina=op/entrega_relatorio3" target="_blank" method="post" name="formEntrega" id="formEntrega" onsubmit="return validaFormNormal('validacoes1');">
            ...
            <select name="id_cliente" id="id_cliente" title="Cliente" onchange="checaDeschecaPeso(this.value, '1');" <? /*onchange="procuraPedidos();" */ ?>>
            ...
            <div id="div_entrega">
                ...
                <input name="entrega" id="entrega" value="1" class="tamanho15p" />
                <br />
            </div>
            <? //} ?>
...
<div class="parte50">
    <fieldset>
        ...
        <form action="index2.php?pagina=op/entrega_relatorio3" target="_blank" method="post" name="formEntrega" id="formEntrega" onsubmit="return validaFormNormal('validacoes2');">
            ...
            <input name="data" id="data2" class="tamanho25p espaco_dir" <? /*onblur="procuraPedidos();"*/ ?> onfocus="displayCalendar(this, 'dd/mm/yyyy', this);" onkeyup="formataData(this);" value="<?=date("d/m/Y");?>" title="Data 1" />
            <br />
            
            <label for="id_cliente2">Cliente:</label>
            <select name="id_cliente" id="id_cliente2" title="Cliente" onchange="checaDeschecaPeso(this.value, '2');" <? /*onchange="procuraPedidos();" */ ?>>
                <option value="">- SELECIONE -</option>
                <?
                $result_cli= mysql_query("select *, pessoas.id_pessoa as id_cliente from pessoas, pessoas_tipos
                                            where pessoas.id_empresa = '". $_SESSION["id_empresa"] ."'
            ...
            <label for="extra2">Tipo de entrega:</label>
            <select name="extra" id="extra2" onchange="processaEntrega(this.value);">
                <option value="0">Entrega normal</option>
            ...
            <? //if ($_GET["tipo"]==2) { ?>
            <div id="div_entrega">
                <label for="entrega2">Entrega:</label>
                <input name="entrega" id="entrega2" value="1" class="tamanho15p" />
                <br />
            </div>
            <? //} ?>
