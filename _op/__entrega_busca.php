...
<div class="parte50">
    <fieldset>
        ...
        <form action="index2.php?pagina=op/entrega_relatorio" target="_blank" method="post" name="formEntrega" id="formEntrega" onsubmit="return validaFormNormal('validacoes1');">
...
<div class="parte50">
    <fieldset>
        ...
        <form action="index2.php?pagina=op/entrega_relatorio" target="_blank" method="post" name="formEntrega" id="formEntrega" onsubmit="return validaFormNormal('validacoes2');">
