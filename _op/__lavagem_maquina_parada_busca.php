...
<h2>Relatório de máquina parada - Área Suja</h2>
...
<div id="conteudo_interno">
    <div class="parte50">
        <fieldset>
            ...
            <form action="index2.php?pagina=op/lavagem_maquina_parada_relatorio" target="_blank" method="post" onsubmit="return validaFormNormal('validacoes1');">
    ...
    <div class="parte50">
        <fieldset>
            ...
            <form action="index2.php?pagina=op/lavagem_maquina_parada_relatorio" target="_blank" method="post" name="formLavagemBuscar" id="formLavagemBuscar" onsubmit="return validaFormNormal('validacoes2');">
