...
<div id="conteudo_interno">
    <div class="parte50">
        <fieldset>
            ...
            <form action="index2.php?pagina=op/atraso_relatorio" target="_blank" method="post" name="formSujidadeRelatorio" id="formSujidadeRelatorio">
