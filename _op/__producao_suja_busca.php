...
<div id="conteudo_interno">
    <div class="parte50">
        ...
        <fieldset>
            ...
            <form action="index2.php?pagina=op/producao_suja_relatorio" target="_blank" method="post" name="formProducaoSujaBuscar" id="formProducaoSujaBuscar" onsubmit="return validaFormNormal('validacoes');">
    ...
    <div class="parte50">
        ...
        <fieldset>
            ...
            <form action="./?pagina=op/producao_ajuste" target="_blank" method="post" name="formProducaoAjuste" id="formProducaoAjuste" onsubmit="return validaFormNormal('validacoes');">
                ...
                <input class="escondido" type="hidden" id="validacoes" value="periodo@vazio" />
                <input class="escondido" type="hidden" name="geral" value="<?= $_GET["geral"]; ?>" />
                <input class="escondido" type="hidden" name="id_departamento" value="2" />
