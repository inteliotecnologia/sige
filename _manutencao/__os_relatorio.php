...
if (pode_algum("jkps", $_SESSION["permissao"])) {
	...
	$pdf->Cell(0, 0.6, "RELATÓRIO GERAL DE OS", 0 , 1, 'R');
	...
	$pdf->Cell(0, 0.6, "Ordens de serviço por funcionário:", 0 , 1, 'L');
	$pdf->Cell(0, 0.2, "", 0, 1);
	...
	$pdf->Ln();
	$pdf->SetFont('ARIAL_N_NEGRITO', '', 10);
	$pdf->Cell(0, 0.6, "Ordens de serviço abertas:", 0 , 1, 'L');
	$pdf->Cell(0, 0.2, "", 0, 1);
	...
	$pdf->Cell(2, 0.6, "ABERTAS", 1, 1, "C", 1);
	...
	$pdf->Cell(2, 0.5, $linhas_total_abertas, 1, 1, "C", $fill);
