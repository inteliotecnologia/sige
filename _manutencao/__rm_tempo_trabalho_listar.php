...
?>
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td align="center">
                <a href="javascript:void(0);" onclick="ajaxLink('tela_tempo_servico', 'carregaPagina&amp;acao=e&amp;pagina=manutencao/rm_tempo_trabalho_form&amp;id_rm_servico=<?=$rs_tempo->id_rm_servico;?>&amp;id_rm=<?=$rs_tempo->id_rm;?>'); abreDiv('tela_tempo_servico');">
	                <img border="0" src="images/ico_lapis.png" alt="Editar" />
                </a>
                
                <a href="javascript:ajaxLink('tempo_servico', 'excluiRMServico&amp;id_rm=<?= $rs_tempo->id_rm; ?>&amp;id_rm_servico=<?= $rs_tempo->id_rm_servico; ?>');" onclick="return confirm('Tem certeza que deseja excluir?');">
