...
?>
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td align="center">
                <a href="javascript:void(0);" onclick="ajaxLink('tela_tempo_servico', 'carregaPagina&amp;acao=e&amp;pagina=manutencao/os_tempo_trabalho_form&amp;id_os_servico=<?=$rs_tempo->id_os_servico;?>&amp;id_os=<?=$rs_tempo->id_os;?>'); abreDiv('tela_tempo_servico');">
	                <img border="0" src="images/ico_lapis.png" alt="Editar" />
                </a>
                
                <a href="javascript:ajaxLink('tempo_servico', 'excluiOSServico&amp;id_os=<?= $rs_tempo->id_os; ?>&amp;id_os_servico=<?= $rs_tempo->id_os_servico; ?>');" onclick="return confirm('Tem certeza que deseja excluir?');">
